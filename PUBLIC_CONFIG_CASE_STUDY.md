...
This optional path applies the artifact's static extraction and generated-replay
...
The default command remains the recommended offline reviewer path:
...
artifact_results/public_policy_workload_metrics.csv
artifact_results/public_source_extraction_metrics.json
```
